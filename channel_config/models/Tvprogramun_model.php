...
class Tvprogramun_model extends CI_Model {
	...
	public function get_list_channel(){
		...
		$db = $this->clickhouse->db();
		$query = "
			SELECT * FROM CHANNEL_PARAM_FINAL
	...
	public function add_new_channel_param_final_res($data){
		...
		$query = " ALTER TABLE CHANNEL_PARAM_FINAL_RES DELETE WHERE CHANNEL_NAME = '".$data['channel_name']."' ";
		$sql	= $db->write($query);
		
		$query = "INSERT INTO CHANNEL_PARAM_FINAL_RES VALUES ('".$data['channel_name']."','".$data['channel_fe']."','".$data['status']."','','".$data['genre']."','".$data['number']."','HD','','".$data['regional']."','".$data['category']."','".$data['color']."','".$data['uri']."',1,0) ";
		$sql	= $db->write($query);
	}
	...
	public function add_new_channel_param_final_eval($data){
		...
		$query = " ALTER TABLE CHANNEL_PARAM_FINAL_EVAL DELETE WHERE CHANNEL_NAME = '".$data['channel_name']."' ";
		$sql	= $db->write($query);
		
		$query = "INSERT INTO CHANNEL_PARAM_FINAL_EVAL VALUES ('".$data['channel_name']."','".$data['channel_fe']."','".$data['status']."','','".$data['genre']."','".$data['number']."','HD','','".$data['regional']."','".$data['category']."','".$data['color']."','".$data['uri']."',1,0) ";
		$sql	= $db->write($query);
	}
	...
	public function add_new_channel_param_final($data){
		...
		$query = " ALTER TABLE CHANNEL_PARAM_FINAL DELETE WHERE CHANNEL_NAME = '".$data['channel_name']."' ";
		$sql	= $db->write($query);
		
		$query = "INSERT INTO CHANNEL_PARAM_FINAL VALUES ('".$data['channel_name']."','".$data['channel_fe']."','".$data['status']."','','".$data['genre']."','".$data['number']."','HD','','".$data['regional']."','".$data['category']."','".$data['color']."','".$data['uri']."',1,0) ";
		$sql	= $db->write($query);
	}
	...
	public function add_new_channel_param($data){
		...
		$query = " ALTER TABLE CHANNEL_PARAM DELETE WHERE CHANNEL_NAME = '".$data['channel_name']."' ";
		$sql	= $db->write($query);
		
		$query = "INSERT INTO CHANNEL_PARAM VALUES ('".$data['channel_name']."','".$data['channel_name']."','".$data['status']."','','','".$data['color']."',0,'".$data['genre']."','".$data['number']."','HD','','".$data['regional']."','".$data['category']."',0) ";
		$sql	= $db->write($query);
	}
