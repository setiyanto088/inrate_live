...
class Createprofileu extends JA_Controller {
  public function __construct()
	...
	public function index()
	{
		...
		$this->template->load('maintemplate', 'createprofileu/views/listu_view', $data);
	}
	...
	// public function create(){
		...
		// $this->template->load('maintemplate', 'createprofileu/views/createprofileu_view', $data);
		
	// }
	
	// public function detail($id){
		// $data['detail'] = $this->createprofileu_model->detailnew($id);
		// $this->template->load('maintemplate', 'createprofileu/views/detailprofileu_view', $data);
	 ...
	 // {
		...
		// foreach ( $list['data'] as $k => $v ) {
			...
			// if($v['status'] == 2){
				// $ss = $v['name'];
			// }else{
					// $ss = "<a href='".base_url()."createprofileu/detail/".$v['idprofile']."' >".$v['name']."</a>";
			// }
	...
	// public function run_jobs(){
		...
		// if ( $list !== false ) {
			...
			// $command = 'php /var/www/jobs/profiling/ultimate/profile_jobs_fta2.php '.$list.' > /var/www/jobs/profiling/ultimate/log_profile_n_'.$list.'test1.log 2>&1 & ';  
