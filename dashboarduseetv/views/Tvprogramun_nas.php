		 ...
		 <div class="row">
              ...
              <div class="panel-body">
				...
				<div class="result-table" style="overflow-x:hidden"> 
								...
								<div id="table_program_channel">
									<table aria-describedby="mydesc"  id="example3" class="table table-striped" style="white-space: nowrap; font-size:11px !important;width:100%">
		   ...
		   <div class="col-lg-12" >	
		    ...
		    <div class="panel urate-panel urate-panel-result" style="border:1px solid #efefef;padding:10px">
              <div class="panel-headings">
				<div class="pull-left" >
                  <h5 class='urate-panel-title' ><strong>Top 10 Program</strong></h5>
				</div>				  
				<div class="pull-right"  >
				<input type="checkbox" value="fta" id="fta_channel_program" checked='checked' onclick="program_change();">Include FTA</label>
				</div>
              </div>
			   <br>
			  <br>
				...
				<div class="result-table" style="overflow-x:hidden">
								...
								<div id="table_program_program">
									<table aria-describedby="mydesc"  id="example34" class="table table-striped" style=" font-size:11px !important;table-layout:fixed;">
										<thead style="color:red">
											<tr>
												<th rowspan="2" style="width:15px" scope="col">Rank </th>
												<th colspan="2" scope="row">Program </th>
	...
	if($('#fta_channel').is(':checked')){
	 ...
	 $("#table_program_channel").append(' <img alt="img" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif">');
			...
			$.ajax({
				...
				url: "<?php echo base_url().'dashboarduseetv/filter_channel_nas'; ?>", 
			...
			$.ajax({
				url: "<?php echo base_url().'dashboarduseetv/filter_program_nas'; ?>", 
				dataType: 'json',  // what to expect back from the PHP script, if anything
				cache: false,
				contentType: false,
				processData: false,
				...
				success: function(data){
					...
					$('#table_program_program').append(' <div class="col-lg-1" ></div> <div class="col-lg-10" >	<canvas id="myChart3"><canvas></div> <div class="col-lg-1" >	 </div>');
