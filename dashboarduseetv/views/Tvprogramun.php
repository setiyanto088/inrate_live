		...
		<br>
		 <div class="row">
              ...
              <div class="panel-body">
				...
				<div class="result-table" style="overflow-x:hidden">
								...
								<div id="table_program_channel">
									<table aria-describedby="mydesc"  id="example3" class="table table-striped" style="overflow-x:auto;white-space: nowrap; font-size:11px !important;">
										<thead style="color:red">
											<tr>
												<th style="width:15px" scope="row">Rank </th>
												<th  scope="row">Regional 1 </th>
												<th  scope="row">Regional 2 </th>
												<th  scope="row">Regional 3 </th>
												<th  scope="row">Regional 4 </th>
												<th  scope="row">Regional 5 </th>
												<th  scope="row">Regional 6 </th>
												<th  scope="row">Regional 7 </th>
											</tr>
              ...
              <div class="panel-body">
				...
				<div class="result-table" style="overflow-x:hidden">
								...
								<div id="table_program">
									<table aria-describedby="mydesc"  id="example32" class="table table-striped" style=" overflow-x:auto;white-space: nowrap; font-size:11px !important;">
										<thead  style="color:red">
											<tr>
												<th style="width:15px" scope="row">Rank </th>
												<th scope="row">Regional 1 </th>
		   ...
		   <div class="col-lg-12" >	
		     ...
		     <div class="panel urate-panel urate-panel-result" style="border:1px solid #efefef;padding:10px">
              <div class="panel-headings">
                  <h5 class='urate-panel-title' ><strong>Top 10 Program</strong></h5> <div class="pull-right"  ><input type="checkbox" value="fta" id="fta_channel_program" checked='checked' onclick="program_change();">Include FTA</label></div>
              </div>
			  <br>
			  <br>
              <div class="panel-body">
									...
									<table aria-describedby="mydesc"  id="example34" class="table table-striped" style=" font-size:11px !important;table-layout:fixed;">
										<thead  style="color:red">
											<tr>
												...
												<th colspan="2" scope="row">Regional 1 </th>
												
												<th colspan="2" scope="row">Regional 2 </th>
												<th colspan="2" scope="row">Regional 3 </th>
												<th colspan="2" scope="row">Regional 4 </th>
												<th colspan="2" scope="row">Regional 5 </th>
												<th colspan="2" scope="row">Regional 6 </th>
												<th colspan="2" scope="row">Regional 7 </th>
...
function table_sel(){
		...
		var tahun = $('#periode_head').val();
			...
			$.ajax({
				...
				success: function(data){
					...
					var table_html = '<table aria-describedby="mydesc"  id="example3" class="table table-striped " style="overflow-x:auto;white-space: nowrap; font-size:11px !important;"><thead style="color:red"><tr><th class="sorting">Rank </th><th class="sorting">Regional 1 </th><th class="sorting">Regional 2 </th><th class="sorting">Regional 3 </th><th class="sorting">Regional 4 </th><th class="sorting">Regional 5 </th><th class="sorting">Regional 6 </th><th class="sorting">Regional 7 </th></tr></thead></table>';
	...
	$('#table_program').html("");
	$('#table_program').append('<table aria-describedby="mydesc"  id="example32" class="table table-striped " style="font-size:11px !important;"><thead style="color:red"><tr><th style="width:15px">Rank </th><th>Regional 1 </th><th>Regional 2 </th><th>Regional 3 </th><th>Regional 4 </th><th>Regional 5 </th><th>Regional 6 </th><th>Regional 7 </th></tr></thead></table>');
		...
		var tahun = $('#periode_head').val();
			...
			$.ajax({
				...
				success: function(data){
					...
					var table_html = '<table aria-describedby="mydesc"  id="example34" class="table table-striped " style=" font-size:11px !important;table-layout:fixed;"><thead style="color:red"><tr><th rowspan="2">Rank </th><th colspan="2">Regional 1 </th><th colspan="2">Regional 2 </th><th colspan="2">Regional 3 </th><th colspan="2">Regional 4 </th><th colspan="2">Regional 5 </th><th colspan="2">Regional 6 </th><th colspan="2">Regional 7 </th></tr><tr><th>Program</th><th>Channel</th><th>Program</th><th>Channel</th><th>Program</th><th>Channel</th><th>Program</th><th>Channel</th><th>Program</th><th>Channel</th><th>Program</th><th>Channel</th><th>Program</th><th>Channel</th></tr></thead></table>';
...
$( document ).ready(function() {				
 ...
 $("#filter2_nas").removeClass("menu_link_select");
 $("#filter2_nas").addClass("menu_link");
 $("#filter2_reg").addClass("menu_link_select");
...
function filter_period(reg){
	
		var url = '<?php echo base_url(); ?>dashboarduseetv/regional_full';
		var tahun = $('#periode_head').val();
		var bulan = "";
