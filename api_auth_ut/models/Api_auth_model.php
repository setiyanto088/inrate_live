...
class Api_auth_model extends CI_Model {
		 ...
		 */
		 ...
		 public function loginCheck($params = array()) { 
			...
			if($result[0]['CNT'] == 0){
				...
				//print_r($resultRole);die;
				
				$datas = array(
					'id' => $params['user_id'],
					'username' => $params['username'],
					'pwd' => '',
					'nama' => $params['fullname'],
					'id_role' => $params['group_id'],
					'type_role' =>'1',
					'status_akses' => '1',
					'tmplahir' => '',
					'tgllahir' => '',
					...
					$this->db->insert('hrd_profile', $datas);
