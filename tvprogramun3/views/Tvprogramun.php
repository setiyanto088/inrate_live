                ...
                <div class="widget-content">
					...
					<div id="table_program28" style="margin-top:-30px">
						<table aria-describedby="table" id="example48" class="table table-striped  example" style="width: 100%">
							<thead style="color:red">
								<tr>
									<th rowspan=2  scope="col">Rank <img  class="cArrowDown" alt="arrow" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th>
									<th rowspan=2 scope="col" >Channel <img  class="cArrowDown" alt="arrow" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th>
									<th colspan=5  scope="row"><?PHP ECHO $tahunselected; ?> <img class="cArrowDown" alt="arrow" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th>
									
								</tr>
								<tr>
									<th scope="row">Audience <img  class="cArrowDown" alt="arrow" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th>
									<th scope="row">TVR <img  class="cArrowDown" alt="arrow" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th>
									<th scope="row">TVS <img  class="cArrowDown" alt="arrow" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th>
									<th scope="row">Views <img class="cArrowDown" alt="arrow" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th>
									<th scope="row">Reach <img  class="cArrowDown" alt="arrow" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th>
								</tr>
