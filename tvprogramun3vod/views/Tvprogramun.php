        ...
        <div class="row">
          <div class="col-md-5">                                   
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Kategory & Title</li>
            </ol>
            <h3 class="page-titles"><strong>Kategory & Title</strong></h3>
          </div>
          ...
          <div class="grid-stack-item" data-gs-min-width="6" data-gs-min-height="1" data-gs-x="3" data-gs-y="0" data-gs-width="12" data-gs-height="2"
            ...
            <div class="panel urate-panel row" style="border:1px solid #efefef;padding:10px;margin:10px;border-radius: 25px;">
                <div class="navbar-left" style="padding-left:10px;">
				  <h4 class="title-periode1"><strong>Viewers By Category (Monthly & Weekly)</strong></h4>
                </div>
                ...
                <div class="widget-content">
					...
					<div class="col-lg-12 filter_panel" id="filter_panel_channels" style="display:none;padding:10px">	
						<div class="col-lg-12">	
						  ...
						  <div class="col-lg-12">
							...
							<input type="hidden" id="tipe_filter2" name="tipe_filter2" value="live"/>
						...
						<table aria-describedby="table" id="example42" class="table table-striped example" style="width: 100%">
							<thead style="color:red">
								<tr>
									...
									<th rowspan = "0"  scope="row">Category <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>
            ...
            <div class="panel urate-panel row" style="border:1px solid #efefef;padding:10px;margin:10px;border-radius: 25px;">
                <div class="navbar-left" style="padding-left:10px;">
                  <h4 class="title-periode3"><strong>Viewers By Title (Monthly & Weekly)</strong></h4>
                </div>
				<div class="navbar-right" style="padding-right:20px;padding-top:10px;">
                ...
                <div class="widget-content">
					...
					<div class="col-lg-12 filter_panel" id="filter_panel_program" style="display:none;padding:10px;">	
						<div class="col-lg-12">	
							<div class="navbar-left">
								<h6 class="" style="font-weight: bold;">Filter</h6>
							</div>
						 ...
						 <div class="col-lg-12">
							...
							<div class="col-lg-3">	
								<div class="form-group">
									...
									<select class="form-control" name="profile_chan3" id="profile_chan3"  >
										<option value="0" selected >All People</option>
										<?php foreach($profile as $prfs){
							...
							<input type="hidden" class="form-control" name="tipe_filter3" id="tipe_filter3" value="live" >
						...
						<table aria-describedby="table" id="example3" class="table table-striped table-bordered example" style="width: 100%">
							<thead>
								<tr>
									...
									<th scope="row">Title <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>
									<th scope="row">Category <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>
									<?php $k = 1; foreach($monthdt as $monthdts){ ?>
									<th  scope="row"><?php echo $monthdts['PERIODE']; ?></th>
									<?php  $k++; } ?>	
									<th rowspan = "0"  scope="row">Total<img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>									
...
<script async >
		...
		function delete_channel(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3vod/delete_channels'?>",
				  method : "POST",
				  data : form_data,
		...
		function save_channel_list(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3vod/save_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
	...
	function load_modal_load_channel(){
			 ...
			 var form_data = {
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3vod/load_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
   ...
   function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvprogramun3vod/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query +"&g=" + genre,
             dataType: 'json',
...
function selectAll(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3vod/header_change'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function program_change(){
	...
	$('#table_program').html('<table aria-describedby="table" id="example3" class="table table-striped table-bordered example" style="color:black"><thead><tr><th>Rank <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th><th>'+field+' <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th><th>Category <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th><th>'+tpe+' <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th></tr></thead></table>');
	...
	$('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3vod/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+type+ "&tgl2="+tgl+"&week2="+week+"&check="+check+"&tipe_filter_prog="+tipe_filter_prog,
		"searching": true,
		"scrollX": true,
		"language": {
            "decimal": ",",
...
function channel_change(){
  ...
  $("#example4_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 0px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img alt="image" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3vod/audiencebar_by_channel'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
var search_val = $( "input[aria-controls='example3']" ).val();
  ...
  var user_id = $.cookie(window.cookie_prefix + "user_id");
	...
	var table3 = $('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3vod/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+fieldas+ "&tgl2="+tgl2+"&week2="+week2+"&searchtxt="+search_val+"&check=True",
		"searching": true,
		"scrollX": true,
		"language": {
            "decimal": ",",
	...
	$('#channel_export').on('click', function() {
	  ...
	  $("#channel_export").attr("disabled", true);
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3vod/audiencebar_by_channel_export'; ?>", 
			dataType: 'text',   
			cache: false,
			contentType: false,
			processData: false,
	...
	// form_data.append('tgl', tgl);
 	  ...
 	  var url = "<?php echo base_url().'tvprogramun3vod/audiencebar_by_program_export'; ?>";
...
function day_view_f(){
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3vod/filter_days'; ?>", 
			dataType: 'text',  
			cache: false,
			contentType: false,
			processData: false,
...
function viewall(){
		...
		var url = '<?php echo base_url(); ?>tvprogramun3tvvir'; 
		var tahun = $('#tahun').val();
		var bulan = $('#bulan').val();
...
function table1_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3vod/cost_by_program'; ?>", 
		dataType: 'json',  
		cache: false,
		contentType: false,
		processData: false,
...
function chanel_export2(){
	...
	var url = "<?php echo base_url().'tvprogramun3vod/audiencebar_by_channel_export2'; ?>";
		 var form = $("<form action='" + url + "' method='post' target='_blank'>" +
			"<input type='hidden' name='cond' value='<?php echo $cond; ?>' />" +
			"<input type='hidden' name='check' value='" + check + "' />" +
			"<input type='hidden' name='type' value='" + type + "' />" +
	...
	// $.ajax({
			// url: "<?php echo base_url().'tvprogramun3vod/audiencebar_by_channel_export2'; ?>", 
			// dataType: 'text',   
			// cache: false,
			// contentType: false,
			// processData: false,
...
function audiencebar_view2(){
  ...
  $("#example42_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 750px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img alt="image" id="loading2" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3vod/audiencebar_by_channel42'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
function table2_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3vod/get_header_tbl'; ?>", 
		dataType: 'json',  
		cache: false,
		contentType: false,
		processData: false,
		...
		success: function(data){
			...
			$('#example3').DataTable({
				...
				"serverSide": true,
				"destroy": true,
				"ajax": "<?php echo base_url().'tvprogramun3vod/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+type+ "&tgl2="+tgl+"&week2="+week+"&check="+check+"&profile="+profile_prog+"&tipe_filter_prog="+tipe_filter_prog+"&preset="+preset3,
				"searching": true,
				"scrollX": true,
				"language": {
					"decimal": ",",
...
function view_daypart(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3vod/daypart_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
function day_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3vod/day_view'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function ads_type_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3vod/ads_view'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
