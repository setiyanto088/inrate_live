        ...
        <div class="row">
          <div class="col-md-5">                                   
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Audience by Program Name</li>
            </ol>
            <h3 class="page-title">Audience by Program Name</h3>
          </div>
						 ...
						 <div class="col-lg-12">
							...
							<div class="col-lg-3">
								...
								<select class="form-control" name="preset3" id="preset3" class="preset2" >  
									...
									<?php foreach($genre as $prfs){
										
										echo '<option value="'.$prfs['GENRE'].'"  >'.$prfs['GENRE'].'</option>';
									} ?>
								</select> 
							</div>
...
<script async >
		...
		function delete_channel(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvirprog/delete_channels'?>",
				  method : "POST",
				  data : form_data,
		...
		function save_channel_list(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvirprog/save_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
	...
	function load_modal_load_channel(){
			 ...
			 var form_data = {
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvirprog/load_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
   ...
   function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvprogramun3tvvirprog/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query +"&g=" + genre,
             dataType: 'json',
...
function selectAll(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvirprog/header_change'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function program_change(){
	...
	$('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3tvvirprog/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+type+ "&tgl2="+tgl+"&week2="+week+"&check="+check+"&tipe_filter_prog="+tipe_filter_prog,
		"searching": true,
		"language": {
            "decimal": ",",
            "thousands": "."
...
function channel_change(){
  ...
  $("#example4_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 0px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img alt="image" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvirprog/audiencebar_by_channel'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
var search_val = $( "input[aria-controls='example3']" ).val();
  ...
  var user_id = $.cookie(window.cookie_prefix + "user_id");
	...
	var table3 = $('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3tvvirprog/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+fieldas+ "&tgl2="+tgl2+"&week2="+week2+"&searchtxt="+search_val+"&check=True",
		"searching": true,
		"language": {
            "decimal": ",",
            "thousands": "."
	...
	$('#channel_export').on('click', function() {
	  ...
	  $("#channel_export").attr("disabled", true);
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvirprog/audiencebar_by_channel_export'; ?>", 
...
function day_view_f(){
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvirprog/filter_days'; ?>", 
			dataType: 'text',  
			cache: false,
			contentType: false,
			processData: false,
...
function table1_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvirprog/cost_by_program'; ?>", 
		dataType: 'json',  
		cache: false,
		contentType: false,
		processData: false,
...
function chanel_export2(){
	...
	$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvirprog/audiencebar_by_channel_export2'; ?>", 
			dataType: 'text',   
			cache: false,
			contentType: false,
			processData: false,
...
function audiencebar_view2(){
  ...
  $("#example42_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 750px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img alt="image" id="loading2" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvirprog/audiencebar_by_channel42'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function table2_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvirprog/get_header_tbl'; ?>", 
		dataType: 'json',   
		cache: false,
		contentType: false,
		processData: false,
		...
		success: function(data){
			...
			$('#example3').DataTable({
				...
				"serverSide": true,
				"destroy": true,
				"ajax": "<?php echo base_url().'tvprogramun3tvvirprog/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+type+ "&tgl2="+tgl+"&week2="+week+"&check="+check+"&profile="+profile_prog+"&tipe_filter_prog="+tipe_filter_prog+"&preset="+preset3,
				"searching": true,
				"language": {
					"decimal": ",",
					"thousands": "."
...
function view_daypart(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvirprog/daypart_view'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function day_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvirprog/day_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
function ads_type_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvirprog/ads_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
