      ...
      <div class="row">
          <div class="col-md-5">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Viewing Pattern</li>
              </ol>
              <h3 class="page-title-inner"><strong>Viewing Pattern</strong></h3>
          </div>    
    	...
    	$(function () {                   
          ...
          $('#from, #to').timepicker({
              ...
              ,change: function(time){
                  ...
                  $.ajax({
                      type	: "POST",
                      url		: "<?php echo base_url().'viewpattern/checkdaypart/'; ?>"+"?f="+$('#from').val()+"&t="+$('#to').val(),
                       dataType: 'json',
          ...
          $('#custom_profile').click(function() {   
              ...
              $.ajax({
                  type	: "POST",
                  url		: "<?php echo base_url().'viewpattern/setprofile/'; ?>"+"?f="+$('#start_date').val(),
                   dataType: 'json',
                  contentType: 'application/json; charset=utf-8',
                  success	: function(response) {
  ...
  <script language="javascript">
	   ...
	   function search_chart(group=""){
          ...
          var form_data = {
              ...
              cgroup     : colgroup
			    ...
			    $.ajax({
				  url : "<?php echo base_url().'viewpattern/list_charttvcc'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'viewpattern/list_charttvcc2'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
				 ...
				 tooltips: {
                      callbacks: {
                          label: function(t,d) { 
							  ...
							  return ['CHANNEL : '+dts[t.datasetIndex].CHANNEL[t.index],'TIME : '+dts[t.datasetIndex].TIME[t.index],'VIEWERS : '+dts[t.datasetIndex].VIEWER[t.index]];
                           }
                      }
                  },
    ...
    function search_genre(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'viewpattern/genresearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query,
             dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
	...
	function search_program(){
		...
		if(res.length > 1 || res == '0' ){
			...
			$.ajax({ 
				type	: "POST",
				url		: "<?php echo base_url().'viewpattern/programsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + channel + "&d=" + start_date + "&de=" + end_date,
 				dataType: 'json',
				contentType: 'application/json; charset=utf-8',
				success	: function(response) {
 					$("#program").next().next().next().empty('');
    ...
    function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'viewpattern/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query +"&g=" + genre,
             dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
    ...
    function search_profile(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'viewpattern/profilesearch/'; ?>"+"?q="+query+"&f="+period,
             dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
                 $("#profile").next().next().next().empty('');
