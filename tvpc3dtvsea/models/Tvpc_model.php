...
$query = " SELECT CHANNEL_NAME AS channel FROM `CHANNEL_PARAM_FINAL` C
  ...
  public function list_tvpc_export($params = array()) {
	  ...
	  $db = $this->clickhouse->db();
		...
		$sql2 = "
		SELECT A.*,(A.VIEWERS/B.VIEWERS)*100 AS REACH FROM M_SUMMARY_MEDIA_PLAN_D_PTV_NEW_DTV_SEA A 
		JOIN M_SUM_TV_DASH_DATE_PTV B ON toString(A.`DATE`) = B.`DATE` WHERE CHANNEL IN (".$params['channel'].") AND DATE BETWEEN '".$params['start_date']."' AND '".$params['end_date']."'
...
// SELECT COUNT(*) CNT FROM (
		...
		if(($params['offset']+10) > $total_filtered['ROWS']){
			...
			$limit_data = $params['limit'] ;
						...
						// $sql2		= 'SELECT * FROM M_SUMMARY_MEDIA_PLAN_D_PTV_NEW_DTV_SEA WHERE CHANNEL IN ('.$params['channel'].') AND DATE BETWEEN "'.$params['start_date'].'" AND "'.$params['end_date'].'"
						// AND (DATE_FORMAT(BEGIN_PROGRAM,"%H:%i:%s") BETWEEN "'.$params['starttime'].':00" AND "'.$params['endtime'].':00"
						// OR DATE_FORMAT(END_PROGRAM,"%H:%i:%s") BETWEEN "'.$params['starttime'].':00" AND "'.$params['endtime'].':00" )
						// AND TIME_PERIODE = "TVPC" 
						// AND PROFILE_ID = '.$params['profile'].'
		 ...
		 $sql2 = "
		SELECT 0 AS rank, A.*,(A.VIEWERS/B.VIEWERS)*100 AS REACH FROM M_SUMMARY_MEDIA_PLAN_D_PTV_NEW_DTV_SEA A 
		JOIN M_SUM_TV_DASH_DATE_PTV B ON toString(A.`DATE`) = B.`DATE`  WHERE CHANNEL IN (".$params['channel'].") AND DATE BETWEEN '".$params['start_date']."' AND '".$params['end_date']."'
		AND ( BEGIN_PROGRAM BETWEEN '".$params['start_date']." ".$params['starttime']."' AND '".$params['end_date']." ".$params['endtime']."'
		OR END_PROGRAM BETWEEN '".$params['start_date']." ".$params['starttime']."' AND '".$params['end_date']." ".$params['endtime']."' )
		AND TIME_PERIODE = 'TVPC' 
	...
	public function listchart_tvpc($params = array()) {	
		...
		// $result = $query->result_array();
		 ...
		 $sql = "
				SELECT 0 AS rank, * FROM M_SUMMARY_MEDIA_PLAN_D_PTV_NEW_DTV_SEA WHERE CHANNEL IN (".$params['channel'].") AND DATE BETWEEN '".$params['start_date']."' AND '".$params['end_date']."'
				AND ( BEGIN_PROGRAM BETWEEN '".$params['start_date']." ".$params['starttime']."' AND '".$params['end_date']." ".$params['endtime']."'
				OR END_PROGRAM BETWEEN '".$params['start_date']." ".$params['starttime']."' AND '".$params['end_date']." ".$params['endtime']."' )
				AND TIME_PERIODE = 'TVPC' 
				AND PROFILE_ID = ".$params['profile']."
