      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-5">                                   
             ...
             <h3 class="page-titles" style="font-weight:bold">CDR Channel Parameters</h3>
          </div>
            ...
            <div class="panel urate-panel row" style="border:1px solid #efefef;padding:10px;margin:10px;border-radius: 25px;">
                <div class="col-lg-12">	
					<div class="navbar-left" style="padding-left:10px;">
					  <h4 class="title-periode1" style="font-weight: bold;">Master CDR Channel </h4>
					</div>
						...
						<table aria-describedby="table" id="example4" class="table table-striped example" style="width: 100%">
								...
								<?php $nu = 1; foreach($array_data_channel as $array_data_channels){ ?>
									<tr>
										...
										<th  scope="col" style="vertical-align:top;text-align:left" ><?php echo $array_data_channels['STANDAR_CHANNEL']; ?></th>
										<th  scope="col" style="vertical-align:top;text-align:left" ><?php echo $array_data_channels['CHANNEL_OPEN']; ?></th>
										<th  scope="col" style="vertical-align:top;text-align:left" ><button onclick="update('<?php echo $array_data_channels['CHANNEL'] ?>','<?php echo $array_data_channels['STANDAR_CHANNEL'] ?>','<?php echo $array_data_channels['CHANNEL_OPEN'] ?>')" id="exportWidget" class="button_black" data-complete-text="" style="float: right;"><strong>Update</strong></button></th>
									</tr>
								<?php $nu++; } ?>
								</tbody>
						</table>
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-titles" id="myModalLabel"><strong>New Channel CDR</strong></h4>
				</div>
				<form class="row" id="add_user" method="post" enctype="multipart/form-data" action="<?php echo base_url()."cdr_channel_config/add_channel" ;?>">
				<div class="modal-body">
						<div class="form-group col-md-12">
							<label for="">CDR Channel</label>
							<input type="text" class="form-control urate-form-input" name="cdr" id="cdr" placeholder="" required />
						</div>
						<div class="form-group col-md-12">
							<label for="">Standard Channel</label>
							<input type="text" class="form-control urate-form-input" name="standard" id="standard" placeholder="" required />
						</div>
						<div class="form-group col-md-12">
							<label for="">Standard Quality Channel</label>
							<input type="text" class="form-control urate-form-input" name="quality" id="quality" placeholder="" required />
						</div>
	...
	<div class="modal fade modalDaypart" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-titles" id="myModalLabel"><strong>Update Channel CDR</strong></h4>
				</div>
				<form class="row" id="edit_user" method="post" enctype="multipart/form-data" action="<?php echo base_url()."cdr_channel_config/edit_channel" ;?>">
				<div class="modal-body">
						<div class="form-group col-md-12">
							<label for="">CDR Channel</label>
						...
						<div class="form-group col-md-12">
							<label for="">Standard Channel</label>
							<input type="text" class="form-control urate-form-input" name="standard_edit" id="standard_edit" placeholder=""  required />
						</div>
						<div class="form-group col-md-12">
							<label for="">Standard Quality Channel</label>
...
function update(channel_cdr,channel_standar,channel_open){
	
	$("#cdr_edit").val(channel_cdr);
	$("#standard_edit").val(channel_standar);
	$("#quality_edit").val(channel_open);
	$("#modalUpdate").modal('show');
	
	$("#cdr_edit_data").val(channel_cdr+'|'+channel_standar+'|'+channel_open);
}
...
function processData(rdn_ar) {
	...
	$.ajax({
		type: 'POST',
		url: "<?php echo base_url().'cdr_channel_config/process_data'; ?>",
		//url: 'upload.php',
		contentType: false,
		processData: false,
		data: form_data,
...
if(file_obj != undefined) {
	...
	$.ajax({
		type: 'POST',
		url: "<?php echo base_url().'cdr_channel_config/upload_file'; ?>",
		//url: 'upload.php',
		contentType: false,
		processData: false,
		data: form_data,
