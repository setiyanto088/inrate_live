      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-5">                                   
            ...
            <h3 class="page-title"><strong>TV Program TVV Dashboard</strong></h3>
          </div>
		...
		<div class="col-lg-12">	
			...
			<div class="col-lg-2">	
					<select class="form-control" name="tpe_f" id="tpe_f" required onChange="selectAll()">
		...
		<div class="row">
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:70px" >
                <img alt="image" src="<?php echo $path9;?>images/Frame 12311.png" alt="urate-stat">
              </div>
              <div class="content">
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:70px" >
                <img alt="image" src="<?php echo $path9;?>images/Frame 12312.png" alt="urate-stat">
              </div>
              <div class="content">
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:70px" >
                <img alt="image" src="<?php echo $path9;?>images/Frame 12313.png" alt="urate-stat">
              </div>
              <div class="content">
		  ...
		  <div class="row">
            ...
            <div class="urate-stats">
              <div class="icon" style="max-width:70px" >
                <img alt="image" src="<?php echo $path9;?>images/Frame 123555.png" alt="urate-stat">
              </div>
              <div class="content">
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:70px" >
                <img alt="image" src="<?php echo $path9;?>images/Frame 12314.png" alt="urate-stat">
              </div>
              <div class="content">
                <span class="titles">Total Views</span><br>
                <span class="values" id="tot_viw"><?php echo number_format($total_views_ssss,0,',','.'); ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:70px" >
                <img alt="image" src="<?php echo $path9;?>images/Frame 12315.png" alt="urate-stat">
              </div>
              <div class="content">
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:70px" >
                <img alt="image" src="<?php echo $path9;?>images/Frame 12316.png" alt="urate-stat">
              </div>
              <div class="content">
                <span class="titles">Dur/Views (Min)</span><br>
                <span class="values" id="dur_view"><?php echo number_format(($duration_ssss/$total_views_ssss)*60,2,',','.'); ?>
 						...
 						<div id="table_program2" >
							<table aria-describedby="table" id="example4" class="table table-striped example" style="width: 100%">
								<thead style="color:red">
									<tr>
										<th rowspan = "2"  scope="col" >Rank <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>
										<th rowspan = "2"  scope="col" >Channel <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>
...
<script async >
		...
		function delete_channel(){
			...
			var user_id = $.cookie(window.cookie_prefix + "user_id");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvv/delete_channels'?>",
				  method : "POST",
				  data : form_data,
		...
		function save_channel_list(){
			...
			var user_id = $.cookie(window.cookie_prefix + "user_id");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvv/save_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
	...
	function load_modal_load_channel(){
			 ...
			 var form_data = {
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvv/load_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
   ...
   function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvprogramun3tvv/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&q=" + query +"&g=" + genre,
             dataType: 'json',
...
function selectAll(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvv/header_change'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
	...
	$('#channel_day').on('click', function() {
		...
		form_data.append('periode',"<?php echo $tahunselected ?>");
			...
			var listDate = [];
				...
				$.ajax({
					url: "<?php echo base_url().'tvprogramun3tvv/filter_days_export'; ?>", 
					dataType: 'text',   
					cache: false,
					contentType: false,
					processData: false,
...
function day_view_f(){
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvv/filter_days'; ?>", 
			dataType: 'text',  // what to expect back from the PHP script, if anything
			cache: false,
			contentType: false,
			processData: false,
  ...
  $("#example4_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 0px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img alt="image" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		...
		success: function(data){
			...
			$('#table_program2').html('<table aria-describedby="table" id="example4" class="table table-striped  example" style="width: 100%"><thead style="color:red"><tr><th rowspan = "2" >Rank <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th><th rowspan = "2" >Channel <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th><th colspan = "'+listDate.length+'">'+tpe+' </th></tr>'+clmn+'</thead></table>');
