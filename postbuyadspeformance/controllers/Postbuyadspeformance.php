...
class Postbuyadspeformance extends JA_Controller {
	...
	public function index()
  {
      ...
      $this->template->load('maintemplate', 'postbuyadspeformance/views/Postbuyadspeformance', $data);
  }
	...
	// {			
      ...
      // $kategori	= $this->input->post('valselect');
      // $profile = $_GET['profile'] ? $_GET['profile'] : 0;
      
      // $params['kategori']		= $this->input->post('valselect');
	...
	// public function get_list_adspeformance(){
      ...
      // foreach ( $list['data'] as $k => $v ) {
          ...
          // $arr_path = "https://inrate.id/video/".$array_channel2[$v['CHANNEL']]."/".$arr_date."/";
	...
	// public function get_filter_adspeformance(){
      ...
      // if( !empty($_GET['kategori_by']) ) {
          // $kategoriby = $_GET['kategori_by'];
      // } else {
          // $kategoriby = NULL;
      // }	
      
      // if( !empty($_GET['get_kategori']) ) {
