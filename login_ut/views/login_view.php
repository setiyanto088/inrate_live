...
<body>
	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('https://inrate.telkomsel.co.id/imgs/Frame_448a.png');">
		<!--<div class="container-login100" style="background-image: #fff');"> -->
			<div class="wrap-login100">
				
			<form action="" class="login100-form validate-form" method="post" id="form_login">
					...
					<h4><b>Please Login and Open Application from UTOIP</b></h4>
			...
			<button class="login100-form-btn" ><a href="<?php echo base_url('login/keluar')?>" >
							to Utoip</a>
			</button>
...
<!--===============================================================================================-->
	...
	<script >
		...
		function red() {
			location.href = "<?php echo base_url();?>login/keluar"
		}
