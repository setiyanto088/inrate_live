      ...
      <div class="container-fluid">  
          <div class="row">
              <div class="col-md-6">
                  ...
                  <h3 class="page-title-inner">Daypart</h3>
              </div>     
<div class="col-md-6 text-right">
          ...
          <div class="panel urate-panels">
              <div class="panel-body" style="height: 180px;">
							...
							<input type="hidden" class="form-control" name="value_data" id="value_data" >
                  <div class="row">
					...
					<div class="col-lg-12">	
						...
						<div class="col-lg-3">	
								<div class="form-group">
									...
									<div class="select-wrapper">
									  <select class="urate-select" name="dataf" id="dataf" title="Please Choose data" required >
									...
									<div class="select-wrapper">
									  <select class="urate-select grid-menu" name="get_chnl" id="get_chnl" title="Please choose a Channel..." required>
										<option value="0" >All Channel</option>
										 <option value="1" >All Channel Ads</option>
							...
							<div class="col-lg-3">	
								<div class="form-group">
									<label>Data</label>
									<div class="select-wrapper">
									  <select class="urate-select" name="dataf2" id="dataf2" title="Please Choose data" required >
										  <option value='summary' selected="selected" >Summary</option>
										  <option value='one' >Single Data</option>
									  </select>  
									</div>
								</div>
							</div>
                  ...
                  <!-- Nav tabs -->
				    <div class="row">
							...
							<div class="col-md-10 text-right">
								<button id="button_filters" onClick="exports()" class="button_black"><em class="fa fa-download"></em> &nbsp Export</button>
							</div>	
                    </div>
                  <!-- / Nav tabs -->
	 ...
	 crnewdata = datas;
      ...
      $(document).ready(function(){ 
        ...
        source: function (query, process) {
            return $.get('daypartresp22/listsearchs?q=' + query, function (data) {
                return process(data);
            });
        },
	  ...
	  function select_profile(){
		  ...
		  if(id_profile == 0){
			...
			$("#box_tree").css({'pointer-events':'auto'}); 
			   ...
			   $.ajax({
				  type	: "POST",
				  url		: "<?php echo base_url().'daypartresp22/list_tree_profile/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token,
      ...
      function generate_program (channel, sdate,dateend, sprofile){
          ...
          $.ajax({
              type	: "POST",
              url		: "<?php echo base_url().'daypartresp22/list_program/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token,
              data	: JSON.stringify(form_data),			
              dataType: 'json',
              contentType: 'application/json; charset=utf-8',
              success	: function(response) {
      ...
      function search(){                                    
          ...
          if(profile === null || profile === ''){  
			...
			$('#panel-blank').hide();
					...
					var urls = "<?php echo base_url();?>daypartresp22/cr_pp" + "?sess_user_id=" + user_id + "&sess_token=" + token;
...
// window event not working here
	...
	function create_chart_split(data,channel){
      ...
      function search_program(){
          ...
          $.ajax({
              type	: "POST",
            url		: "<?php echo base_url().'daypartresp22/listsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query + "&d=" + start_date+ "&dend=" + end_date + "&c=" + channel,
               dataType: 'json',
              contentType: 'application/json; charset=utf-8',
              success	: function(response) {
	  ...
	  function refreshtablefilter1(start_date,channel, program, profile){
          ...
          var table = $("#example").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
	  ...
	  function refreshtablefilter2(start_date,channel, program, profile){
          ...
          var by = '';	
             var table2 = $("#example1").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_city'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter3(start_date,channel, program, profile){
          ...
          var by = '';	
		    ...
		    var table3 = $("#example2").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_comm'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter4(start_date,channel, program, profile){
          ...
          var by = '';	
		    ...
		    var table4 = $("#example3").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_persona'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter5(start_date,channel, program, profile){
          ...
          var by = '';	
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_gender'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter6(start_date,channel, program, profile){
          ...
          var by = '';	
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_age'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
    ...
    var table7 = $("#example6").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_digi'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter8(start_date,channel, program, profile){
          ...
          var by = '';	
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_house'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter9(start_date,channel, program, profile){
		  ...
		  var table9 = $("#example9").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_arpu'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter10(start_date,channel, program, profile){
          ...
          var by = '';	
		   ...
		   var table10 = $("#example10").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_ses'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter11(start_date,channel, program, profile){
          ...
          var by = '';	
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'daypartresp22/list_audience_web'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
