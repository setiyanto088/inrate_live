...
class Channelmigration3sea extends JA_Controller {
    ...
    public function index(){
		...
		if(!$this->session->userdata('user_id') || in_array("182",$array_menu) == 0) {
          redirect ('/login');
		}
        ...
        $this->template->load('maintemplate', 'channelmigration3sea/views/Channelmigration_view', $data);
    }
