					...
					<div class="panel-body">
							<div class="row" style="margin-bottom:40px;">
									...
									<div class="col-md-12" style="">
										<span id='table_dex' class='dexs'  style="padding:10px;background:#877678;border: solid 1px #E5E5E5;"><a href="#" data-toggle="tooltip" title="Table" onClick="setType('table')"  ><span class="menu-icon"><img alt="img" height="25px" style="" src="https://inrate.id/imgs/newimgs/carbon_table-split.png" ></span></a></span>&nbsp &nbsp 
										<span id='line_dex' class='dexs' style="padding:10px;border: solid 1px #E5E5E5;margin-left:-12px;" ><a href="#" data-toggle="tooltip" title="Line Chart" onClick="setType('line')" ><span class="menu-icon"><img alt="img" height="25px" src="https://inrate.id/imgs/newimgs/carbon_chart-line.png" ></span></a></span>&nbsp &nbsp 
										<span id='column_dex' class='dexs' style="padding:10px;border: solid 1px #E5E5E5;margin-left:-12px;" ><a href="#" data-toggle="tooltip" title="Column Chart" onClick="setType('column')" ><span class="menu-icon"><img alt="img" height="25px" src="https://inrate.id/imgs/newimgs/carbon_chart-column.png" ></span></a></span>&nbsp &nbsp 
										<span id='bar_dex' class='dexs' style="padding:10px;border: solid 1px #E5E5E5;margin-left:-12px;" ><a href="#" data-toggle="tooltip" title="Bar Chart" onClick="setType('bar')" ><span class="menu-icon"><img alt="img" height="25px" src="https://inrate.id/imgs/newimgs/carbon_chart-bar.png" ></span></a></span>&nbsp &nbsp 
										<span id='area_dex' class='dexs' style="padding:10px;border: solid 1px #E5E5E5;margin-left:-12px;" ><a href="#" data-toggle="tooltip" title="Area Chart" onClick="setType('area')" ><span class="menu-icon"><img alt="img"  height="25px" src="https://inrate.id/imgs/newimgs/carbon_chart-area.png" ></span></a></span>&nbsp &nbsp 
										<span id='scatter_dex' class='dexs' style="padding:10px;border: solid 1px #E5E5E5;margin-left:-12px;" ><a href="#" data-toggle="tooltip" title="Scatter Chart" onClick="setType('scatter')" ><span class="menu-icon"><img alt="img" height="25px" src="https://inrate.id/imgs/newimgs/carbon_chart-scatter.png" ></span></a></span>&nbsp &nbsp 
									</div>
