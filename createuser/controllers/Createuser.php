...
class Createuser extends JA_Controller {
  public function __construct()
   ...
   $this->load->helper(array('form', 'url'));		
	...
	// {
		...
		// $this->template->load('maintemplate', 'createuser/views/listu_view', $data);
	// }
	...
	// public function create(){
		...
		// $this->template->load('maintemplate', 'createuser/views/createuser_view', $data);
	...
	// public function createadmin(){
		...
		// $this->template->load('maintemplate', 'createuser/views/createadmin_view');
	...
	// public function detail($id){
		...
		// $this->template->load('maintemplate', 'createuser/views/detailuser_view', $data);
	...
	public function editself() {
		...
		if(!$this->session->userdata('user_id')) {
			...
			$params['pwd'] = str_replace('_','',str_replace('%','',str_replace('\\','',str_replace('"','',str_replace("'","",$this->Anti_si($_POST['pwd']))))));
			$params['oldpwd']= str_replace('_','',str_replace('%','',str_replace('\\','',str_replace('"','',str_replace("'","",$this->Anti_si($_POST['oldpwd']))))));
			$params['cmfpwd']= str_replace('_','',str_replace('%','',str_replace('\\','',str_replace('"','',str_replace("'","",$this->Anti_si($_POST['cmfpwd']))))));
			$params['token']= str_replace('_','',str_replace('%','',str_replace('\\','',str_replace('"','',str_replace("'","",$this->Anti_si($_POST['token']))))));
	 ...
	 // {
		...
		// foreach ( $list['data'] as $k => $v ) {
				// $ss = "<a href='javascript:void(0)' onClick='editUser(".$v['id'].")' ><button class='btn btn-info waves-effect' >Update User</button></a>"
						// ."<a href='".base_url()."createuser/detail/".$v['id']."' ><button class='btn btn-success waves-effect' >Update Role Menu</button></a>";
	...
	// {
		// $this->load->helper('url');
        // redirect(base_url('createuser/adminlist'));
	// }
	...
	// {
		...
		// $this->template->load('maintemplate', 'createuser/views/listuadmin_view', $data);
	// }
