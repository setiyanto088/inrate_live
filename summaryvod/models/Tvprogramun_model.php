...
class Tvprogramun_model extends CI_Model {
	...
	public function get_total_views($periode){
		...
		$query = "SELECT VALUES as TOTAL_VIEWS FROM SUMMARY_VOD WHERE PERIODE = '".$periode."' AND TYPE_DATA = 'TOTAL VIEWS' " ;
	...
	public function get_duration($periode){
		...
		$query = "SELECT VALUES as DURATION FROM SUMMARY_VOD WHERE PERIODE = '".$periode."' AND TYPE_DATA = 'DURATION' " ;
...
$db = $this->clickhouse->db();
	$query = "SELECT VALUES AS jmlch FROM `SUMMARY_VOD`
	WHERE `PERIODE` = '".$periode."' AND ID_PROFILE = 0 AND TYPE_DATA = 'KATEGORY' ";  		
...
$db = $this->clickhouse->db();
	$query = "SELECT VALUES  AS jmlpr FROM `SUMMARY_VOD`
	WHERE `PERIODE` = '".$periode."' AND ID_PROFILE = 0 AND `TYPE_DATA` = 'PROGRAM'";  		 			
	...
	public function get_active_audience_all($periode){
		...
		$query = "SELECT VALUES AS VIEWERS FROM SUMMARY_VOD WHERE PERIODE= '".$periode."'
		AND TYPE_DATA = 'ACTIVE AUDIENCE' AND ID_PROFILE = 0 " ;
	...
	public function get_total_views_all($periode){
		...
		$query = "SELECT VALUES as TOTAL_VIEWS FROM `SUMMARY_VOD`
		WHERE `PERIODE` = '".$periode."' AND TYPE_DATA = 'TOTAL VIEWS' AND ID_PROFILE = 0 " ;
