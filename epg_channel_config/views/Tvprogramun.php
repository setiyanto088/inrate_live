      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-5">                                   
             ...
             <h3 class="page-titles" style="font-weight:bold">EPG Channel Parameters</h3>
          </div>
            ...
            <div class="panel urate-panel row" style="border:1px solid #efefef;padding:10px;margin:10px;border-radius: 25px;">
                <div class="col-lg-12">	
					<div class="navbar-left" style="padding-left:10px;">
					  <h4 class="title-periode1" style="font-weight: bold;">Channel EPG</h4>
					</div>
						...
						<table aria-describedby="table" id="example4" class="table table-striped example" style="width: 100%">
								<thead style="color:red">
									<tr>
										...
										<th  scope="col" style="vertical-align:top;text-align:center" >Channel EPG</th>
										<th  scope="col" style="vertical-align:top;text-align:center" >Channel Origin</th>
										<th  scope="col" style="vertical-align:top;text-align:center" >Channel CDR</th>
										<th  scope="col" style="vertical-align:top;text-align:center" >Category Channel</th>
								...
								<?php $nu = 1; foreach($array_data_channel as $array_data_channels){ ?>
									<tr>
										...
										<th  scope="col" style="vertical-align:top;text-align:left" ><?php echo $array_data_channels['CHANNEL_ORIGIN']; ?></th>
										<th  scope="col" style="vertical-align:top;text-align:left" ><?php echo $array_data_channels['CHANNEL_CDR']; ?></th>
										<th  scope="col" style="vertical-align:top;text-align:left" ><?php echo $array_data_channels['KATEGORI']; ?></th>
										<th  scope="col" style="vertical-align:top;text-align:center" ><?php echo $status_tpe[$array_data_channels['STATUS']]; ?></th>
										<th  scope="col" style="vertical-align:top;text-align:left" ><button onclick="update('<?php echo $array_data_channels['CHANNEL_ORIGIN'] ?>','<?php echo $array_data_channels['CHANNEL'] ?>','<?php echo $array_data_channels['CHANNEL_CDR'] ?>','<?php echo $array_data_channels['STATUS']; ?>','<?php echo $array_data_channels['KATEGORI']; ?>')" id="exportWidget" class="button_black" data-complete-text="" style="float: right;"><strong>Update</strong></button></th>
									</tr>
								<?php $nu++; } ?>
								</tbody>
						</table>
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-titles" id="myModalLabel"><strong>New Channel EPG</strong></h4>
				</div>
				<form class="row" id="add_user" method="post" enctype="multipart/form-data" action="<?php echo base_url()."epg_channel_config/add_channel" ;?>">
					<div class="modal-body">
						
							<div class="form-group col-md-12">
								<label for="">Channel EPG</label>
								<input type="text" class="form-control urate-form-input" name="epg" id="epg" placeholder="" required />
							</div>
							<div class="form-group col-md-12">
								<label for="">Channel CDR</label>
								<input type="text" class="form-control urate-form-input" name="cdr" id="cdr" placeholder="" required />
							</div>
							<div class="form-group col-md-12">
								<label for="">Channel Origin</label>
								<input type="text" class="form-control urate-form-input" name="origin" id="origin" placeholder="" required />
							</div>
							<div class="form-group col-md-12">
								<label for="">Channel Category</label>
								<select type="text" class="form-control urate-form-input" name="cat_epg" id="cat_epg" required >
							...
							<div class="form-group col-md-12">
								...
								<select type="text" class="form-control urate-form-input" name="status_epg" id="status_epg" required >
					...
					<div class="modal-footer">                                       
						...
						<button type="submit" id="btn_daftar" class="button_black" ><em class="fa fa-check"></em>&nbsp Save</button>
					</div>
				</form>
			</div>
		</div>
	...
	<div class="modal fade modalDaypart" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-titles" id="myModalLabel"><strong>Update Channel EPG</strong></h4>
				</div>
				<form class="row" id="edit_user" method="post" enctype="multipart/form-data" action="<?php echo base_url()."epg_channel_config/edit_channel" ;?>">
				<div class="modal-body">
						
						<div class="form-group col-md-12">
							<label for="">Channel EPG</label>
							<input type="text" class="form-control urate-form-input" name="epg_edit" id="epg_edit" placeholder="" />
							<input type="hidden" class="form-control urate-form-input" name="epg_edit_data" id="epg_edit_data" placeholder="" />
						</div>
						<div class="form-group col-md-12">
							<label for="">Channel CDR</label>
							<input type="text" class="form-control urate-form-input" name="cdr_edit" id="cdr_edit" placeholder="" />
						</div>
						<div class="form-group col-md-12">
							<label for="">Channel Origin</label>
							<input type="text" class="form-control urate-form-input" name="origin_edit" id="origin_edit" placeholder="" />
						</div>
						<div class="form-group col-md-12">
							<label for="">Channel Category</label>
							<select type="text" class="form-control urate-form-input" name="cat_epg_edit" id="cat_epg_edit" >
							<?php foreach($array_data_cat as $array_data_cats){ 
						...
						<div class="form-group col-md-12">
							<label for="">Status</label>
							<select type="text" class="form-control urate-form-input" name="status_epg_edit" id="status_epg_edit" >
								<option value='1'>Active</option>
								<option value='0'>Not Active</option>
							<select/>
						</div>
					
          <div class="dayPartMsgedit"></div>
				</div>
				<div class="modal-footer">                                       
          <img alt="image" class="gambar" src="<?php echo $path; ?>assets/images/icon_loader.gif" id="loaderdpedit" style="display: none;">
					<button type="button" class="button_white" data-dismiss="modal"><em class="fa fa-times"></em>&nbsp Cancel</button>
...
function update(channel_origin,channel,channel_cdr,status,cat){
	
	$("#origin_edit").val(channel_origin);
	$("#epg_edit").val(channel);
	$("#cdr_edit").val(channel_cdr);
	$("#status_epg_edit").val(status);
	$("#cat_epg_edit").val(cat);
	$("#modalUpdate").modal('show');
	
	$("#epg_edit_data").val(channel_origin+'|'+channel+'|'+channel_cdr+'|'+status+'|'+cat);
...
function processData(rdn_ar) {
	...
	$.ajax({
		type: 'POST',
		url: "<?php echo base_url().'epg_channel_config/process_data'; ?>",
		//url: 'upload.php',
		contentType: false,
		processData: false,
		data: form_data,
...
if(file_obj != undefined) {
	...
	$.ajax({
		type: 'POST',
		url: "<?php echo base_url().'epg_channel_config/upload_file'; ?>",
		//url: 'upload.php',
		contentType: false,
		processData: false,
		data: form_data,
