...
class tvprogramun3tvvsea extends JA_Controller {
  ...
  public function __construct()
	...
	public function filter_days(){
		...
		if(!$this->session->userdata('user_id') || in_array("179",$array_menu) == 0) {
  ...
  public function index()
	...
	function audiencebar_by_channel_export(){
		...
		if($tipe_filter == 'live'){
			...
			$data['channels'] = $this->tvprogramun_model->list_spot_by_program_all_bar_fix("channel_name",$where,$periode,$pilihaudiencebar,"0","True",$first_day,$this_day,$where_k); 
