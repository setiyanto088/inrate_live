          ...
          <div class="row">
              <div class="col-md-5">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">List Program Comparison</li>
                  </ol>
					...
					<div class="col-lg-12">	
							...
							<div class="col-lg-3">	
								<div class="form-group">
									<label>Data</label>
									<select class="urate-select" name="data" id="data" title="Please Choose a Channel ..." required>
							...
							<div class="col-lg-3">	
								<div class="form-group">
									<label>TV Channel</label>
										<select class="form-control urate-select" name="channel" id="channel" title="Please Choose a Channel ..." required>
											  <option value="0" >All Channel</option>
											  <?php foreach($channels as $nhb) { ?>
											  <option value="<?php echo str_replace("&","AND",$nhb['CHANNEL_CDR']); ?>" ><?php echo $nhb['CHANNEL_CIM']; ?></option>
											  <?php } ?>
										  </select>
								</div>
							</div>
							   ...
							   <div id="table_program42" >
								<table aria-describedby="mydesc"  id="example42" class="table table-striped example" style="width: 100%">
									<thead style="color:red">
										<tr>
											<th  scope="row">No <img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
											<th  scope="row">Genre Program <img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
											<th  scope="row">Program<img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
											<th  scope="row">Channel<img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
											<th  scope="row">Begin Time<img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
											<th  scope="row">End Time<img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
											<th  scope="row">Count <br> of Showtimes<img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
											<th id="sram" >Audience<img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
											<th  scope="row">Average<img alt="img" class="cArrowDown" src="<?php echo $path;?>assets/images/icon_arrowdown.png"></th>
										</tr>
					 ...
					 <div class="form-group dataset col-md-5" style="z-index: 999;margin-bottom:20px">
							...
							<div class="select-wrapper" style="">
                              <select class="urate-select grid-menu" name="channel" id="channel" title="Please Choose a Channel ..." required>
                                  <option value="0" >All Channel</option>
                                  <?php foreach($channels as $key) { ?>
                                  <option value="<?php echo str_replace("&","AND",$key['CHANNEL_CDR']); ?>" ><?php echo $key['CHANNEL_CIM']; ?></option>
                                  <?php } ?> 
                              </select>
							</div> 
					</div> 
...
<!-- Modal New Profile -->
  ...
  function save_channel_list(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'listtvpc/save_channels'?>",
				  method : "POST",
				  data : form_data,
...
//                                console.log(crnewdata);
      ...
      function search(){                                    
		  ...
		  if(data == 'audience'){
			  $('#sram').html('Audience');
		  }else if(data == 'total_views'){
			  $('#sram').html('Total Views');
		  }else{
			   $('#sram').html('Duration');
		  }
          ...
          if(profile === null || profile === ''){  
			...
			if(preset === null || preset === '') { 
				...
				if(channel === null || channel === '') {  
						alert('Please, Select Channel or Preset');
						return false;
				} 	
			...
			$('#panel-blank').hide();
					 ...
					 $.ajax({ 
                        ...
                        contentType: 'application/json; charset=utf-8'
						 ...
						 obj =response.data['data'];
						    ...
						    $('#example42').dataTable().fnClearTable();
							$('#example42').dataTable().fnDestroy();
				...
				"searching": true,
							...
							columns: [
								...
								{ data: 'JAM_MULAI' },
								{ data: 'JAM_AKHIR' },
								{ data: 'CNT' ,"sClass": "right",render: function ( data, type, row ) {
									return new Intl.NumberFormat('id-ID').format(parseFloat(data).toFixed(2));
									 
									}
								},
								{ data: 'DATA' ,"sClass": "right",render: function ( data, type, row ) {
									return new Intl.NumberFormat('id-ID').format(parseFloat(data).toFixed(2));
									 
									}
								},
								{ data: 'AVGDATA' ,"sClass": "right",render: function ( data, type, row ) {
									return new Intl.NumberFormat('id-ID').format(parseFloat(data).toFixed(2));
	...
	function export_aud(ads){
		...
		$.ajax({
			url: "<?php echo base_url().'listtvpc/audience_export'; ?>", 
			dataType: 'text',  
			cache: false,
			contentType: false,
			processData: false,
...
// window event not working here
    ...
    // for IE < 11
      ...
      function search_program(){
          ...
          $.ajax({
              type	: "POST",
            url		: "<?php echo base_url().'listtvpc/listsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query + "&d=" + start_date+ "&dend=" + end_date + "&c=" + channel,
               dataType: 'json',
              contentType: 'application/json; charset=utf-8',
              success	: function(response) {
	  ...
	  function refreshtablefilter1(start_date,channel, program, profile){
          ...
          var table = $("#example").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
	  ...
	  function refreshtablefilter2(start_date,channel, program, profile){
          ...
          var by = '';	
             var table2 = $("#example1").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_city'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter3(start_date,channel, program, profile){
          ...
          var by = '';	
		    ...
		    var table3 = $("#example2").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_comm'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter4(start_date,channel, program, profile){
          ...
          var by = '';	
		    ...
		    var table4 = $("#example3").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_persona'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter5(start_date,channel, program, profile){
          ...
          var by = '';	
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_gender'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter6(start_date,channel, program, profile){
          ...
          var by = '';	
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_age'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
    ...
    var table7 = $("#example6").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_digi'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter8(start_date,channel, program, profile){
          ...
          var by = '';	
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_house'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter9(start_date,channel, program, profile){
		  ...
		  var table9 = $("#example9").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_arpu'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter10(start_date,channel, program, profile){
          ...
          var by = '';	
		   ...
		   var table10 = $("#example10").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_ses'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
	  ...
	  function refreshtablefilter11(start_date,channel, program, profile){
          ...
          var by = '';	
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'listtvpc/list_audience_web'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              "order": [[ orderingnya, by]],
    ...
    function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'listtvpc/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query + "&d=" + start_date+ "&ed=" + end_date + "&p=" + profile,
             dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
