	...
	<div class="content-wrapper">
      <div class="container-fluid">      
          <div class="row">
              <div class="col-md-6">                    
                  <ol class="breadcrumb">
                    ...
                    <h3 class="page-title-inner"><strong>Media Planning</strong></h3>
				  </div>   
          ...
          <div class="panel urate-panels">
							...
							<div class="col-lg-3">	
								<div class="form-group">
									...
									<div class="select-wrapper">
									  <select class='urate-select grid-menu' name="channels" id="channels" title='Please Choose Channel ...'>
			...
			<img class="gambar" src="<?php echo $path9;?>images/Frame388.png" style=" margin-left: auto;margin-right: auto;display: block;" id="sss" alt="Frame" >
		  
		  </div>
		   <div class="loader" style="display:none">
                 <img class="gambar" src="<?php echo $path; ?>assets/images/icon_loader.gif" alt="Loader">
            </div>
              ...
              <div class="panel-body">
					  ...
					  <div class="col-md-10">
                                <div class="row" style="background-color:#F2F2F2;padding:5px;color:#000;border: none;border-radius:5px">
									 <div class="col-md-2" id="tabs_table" style="border: none;background-color:#fff;border-radius:5px;">
									...
									<div class="col-md-2" id="tabs_chart" style="border: none;border-radius:5px;">
									...
									<div class="col-md-2" id="tabs_chart" style="border: none;border-radius:5px;">
										<button id="tab_summ_compare" style="border: none;border-radius:5px;padding:3px 15px 3px 15px" onclick="tab_filter('summ_compare')" href="#summ_compare" aria-controls="chart" role="tab" data-toggle="tab"><strong>Summary</strong></button>
									</div>
								</div>
                              </div>
                  ...
                  <div class="tab-content" style="margin-top:70px;">
                      ...
                      <div role="tabpanel" class="tab-pane fade in active" id="table">
                            <div class="result-table" id='result-table'>
                                <table id="myTable" class="table table-striped " style="" aria-describedby="Table Result"> 
										   ...
										   <div class="col-md-6">
											 <div class="row" style="padding:5px">
												...
												<div class="col-lg-12 urate-panel" id="summ_prog1">
													...
													<table id="example1" class="table table-striped table-bordered example" style="table-layout:fixed " aria-describedby="Table Summary program">
														<thead>
															  <tr>
										 ...
										 <div class="col-md-6">
											 <div class="row" style="padding:5px">
												...
												<div class="col-lg-12 urate-panel" id="summ_prog2" >
													...
													<table id="example2" class="table table-striped table-bordered example" style="table-layout:fixed " aria-describedby="Table Summary Channel">
														<thead>
															<tr>
																<th scope="row">Channel</th>
																<th scope="row">Ads Type</th>
										...
										<div class="col-md-6">
											 <div class="row" style="padding:5px">
												...
												<div class="col-lg-12 urate-panel" id="summ_prog1ads" >
													<h4>Summary Program</h4>
													<table id="example1_ads" aria-describedby="mydesc" class="table table-striped table-bordered example">
														<thead>
															  <tr>
																  <th scope="row">Channel</th>
																  <th scope="row">Program</th>
										...
										<div class="col-md-6">
											 <div class="row" style="padding:5px">
												...
												<div class="col-lg-12 urate-panel" id="summ_prog2ads">
													<h4>Summary Channel</h4>
													<table id="example2_ads" aria-describedby="mydesc" class="table table-striped table-bordered example" >
														<thead>
															<tr>
																<th scope="row">Channel</th>
																<th scope="row">Ads Type</th>
    ...
    <div id="CalenderModalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-titles" id="myModalLabel2s"><strong>Detail</strong></h4>
          </div>
          <div class="modal-body">
          ...
          <div class="modal-footer">
            <button type="button" class="button_black" data-dismiss="modal">Close</button>
  ...
  <script language="javascript">
      $(document).ready(function(){     
          ...
          $('#custom_profile').click(function() {   
              ...
              $.ajax({
                  type	: "POST",
                  url		: "<?php echo base_url().'advancemediaplanningures/setprofile/'; ?>"+"?f="+$('#start_date').val(),
                  dataType: 'json',
		...
		function print_summary(){
			...
			$.ajax({
				url: "<?php echo base_url().'advancemediaplanningures/print_summary'; ?>", 
				...
				success: function(data){
					...
					download_file('<?php echo $donwload_base; ?>tmp_doc/cal_print_summary.xls','summary_ads_placement.xls');
...
var start_date_ads = $('#start_date_ads').val();
		...
		form_data.append('cr_data', cr_data);
			...
			$.ajax({
				url: "<?php echo base_url().'advancemediaplanningures/print_calender'; ?>", 
				dataType: 'text',  // what to expect back from the PHP script, if anything
				cache: false,
				contentType: false,
				processData: false,
				...
				success: function(data){
					...
					download_file('<?php echo $donwload_base; ?>tmp_doc/cal_print.xls','ads_placement.xls');
...
var start_date_ads = $('#start_date_ads').val();
		...
		form_data.append('cr_data', cr_data);
			...
			$.ajax({
      			url : "<?php echo base_url().'advancemediaplanningures/list_calander2'?>",
				dataType: 'text',  // what to expect back from the PHP script, if anything
				cache: false,
				contentType: false,
				processData: false,
	...
	function export_mp(){
      ...
      function search(){                 
        ...
        if(profile === null || profile === ''){ // value of a text input cannot be null
      	...
      	if(setting === null || setting === ''){ // value of a text input cannot be null
      			// or zero unless you've changed in with JS
		...
		if (setting == "maximum_reach") {  
      	...
      	if(end_date === ''){ // value of a text input cannot be null
      		// or zero unless you've changed in with JS
      		alert('Please, Select End Date');
      		return false;
      	}	
      	
      	if(cost === ''){ // value of a text input cannot be null
      		// or zero unless you've changed in with JS
        ...
        /* HANDLE ALL CHANNEL */         
        if(channel == "0"){
            channel = 'ANTV,INDOSIAR,KOMPAS TV,METRO TV,NET TV,RTV,SCTV,TRANS 7,TRANS TV,TV ONE,TVRI'; 
		...
		$.ajax({
			url: "<?php echo base_url().'advancemediaplanningures/list_planning'; ?>", 
			dataType: 'text',  // what to expect back from the PHP script, if anything
			cache: false,
			contentType: false,
			processData: false,
			...
			success: function(data){
				...
				$('#result-table').html('<table id="myTable" class="table table-striped" style = "width : 100%"><thead style="color:red"> <tr><th align="center">Tanggal</th><th align="center">Channel</th> <th align="center">Program</th> <th align="center">Ads Type</th><th align="right">TVR</th><th align="right">Share</th><th align="right">CPRP</th><th align="right">Cost</th> <th align="right">Cost / Audience</th> <th align="right">Index</th> </tr> </thead> </table>');
                  ...
                  filename: 'UNICS - Media Planning'
						...
						columns: [ 
							...
							{ data: 'PROGRAM' },
							{ data: 'TYPE' },
							{ data: 'TVR_A' ,className: "text-right","sClass": "right",render: function ( data, type, row ) {
								return new Intl.NumberFormat('id-ID').format(parseFloat(data).toFixed(2));
								
								}
							},
							{ data: 'TVS_A' ,className: "text-right","sClass": "right",render: function ( data, type, row ) {
								return new Intl.NumberFormat('id-ID').format(parseFloat(data).toFixed(2));
				...
				$('#summ_prog1').html("");
				$('#summ_prog1').html('<h4><b>Summary Program</b></h4> <table id="example1" class="table table-striped "><thead style="color:red"><tr><th>Channel</th> <th>Program</th><th>Ads Type</th> <th>Spot</th><th>Cost/Spot</th><th>GRP</th></tr></thead></table>');
				...
				$('#summ_prog2').html("");
				$('#summ_prog2').html('<h4><b>Summary Channel</b></h4> <table id="example2" class="table table-striped "><thead style="color:red"><tr><th>Channel</th><th>Ads Type</th> <th>Spot</th><th>Cost/Spot</th><th>GRP</th></tr></thead></table>');
				...
				$('#summ_prog1ads').html("");
				$('#summ_prog1ads').html('<h4><b>Summary Program</b></h4> <table id="example1_ads" class="table table-striped "><thead style="color:red"><tr><th>Channel</th> <th>Program</th><th>Ads Type</th> <th>Spot</th><th>Cost/Spot</th><th>GRP</th></tr></thead></table>');
				...
				$('#summ_prog2ads').html("");
				$('#summ_prog2ads').html('<h4><b>Summary Channel</b></h4> <table id="example2_ads" class="table table-striped "><thead style="color:red"><tr><th>Channel</th><th>Ads Type</th> <th>Spot</th><th>Cost/Spot</th><th>GRP</th></tr></thead></table>');
                  ...
                  filename: 'UNICS - Media Planning'
						...
						columns: [
							...
							{ data: 'TVR'}
      						...
      						//$("#texted").html("");
      						$("#spoted").html("<div class='grandItemTits'><b>Total Spot</b></div><div class='grandItemCon'>" + obj.spot + "</div>");
      						$("#costed").html("<div class='grandItemTits'><b>Total Cost</b></div><div class='grandItemCon'>" + obj.cost + "</div>");
      						$("#tvred").html("<div class='grandItemTits'><b>Total TVR</b></div><div class='grandItemCon'>" + obj.tvr + "</div>");
							
							$("#maxtvr").html("<div class='grandItemTits'><b>Max TVR</b></div><div class='grandItemCon'>" + obj.maxtvr + "</div>");
      						$("#mintvr").html("<div class='grandItemTits'><b>Min TVR</b></div><div class='grandItemCon'>" + obj.mintvr + "</div>");
      						$("#avgtvr").html("<div class='grandItemTits'><b>Avg TVR</b></div><div class='grandItemCon'>" + obj.avgtvr + "</div>");
      						$("#cprp1").html("<div class='grandItemTits'><b>CPRP</b></div><div class='grandItemCon'>" + obj.cprp1 + "</div>");
							
							
      						$("#spoted_ads").html("<div class='grandItemTits'><b>Total Spot</b></div><div class='grandItemCon'>" + obj.spot9 + "</div>");
      						$("#costed_ads").html("<div class='grandItemTits'><b>Total Cost</b></div><div class='grandItemCon'>" + obj.cost9 + "</div>");
      						$("#tvred_ads").html("<div class='grandItemTits'><b>Total TVR</b></div><div class='grandItemCon'>" + obj.tvr9 + "</div>");
							
							$("#maxtvr_ads").html("<div class='grandItemTits'><b>Max TVR</b></div><div class='grandItemCon'>" + obj.maxtvr9 + "</div>");
      						$("#mintvr_ads").html("<div class='grandItemTits'><b>Min TVR</b></div><div class='grandItemCon'>" + obj.mintvr9 + "</div>");
      						$("#avgtvr_ads").html("<div class='grandItemTits'><b>Avg TVR</b></div><div class='grandItemCon'>" + obj.avgtvr9 + "</div>");
      						$("#cprp1_ads").html("<div class='grandItemTits'><b>CPRP</b></div><div class='grandItemCon'>" + obj.cprp19 + "</div>");
			...
			$('#spoted_summ').html('<td align="left" >Total Spot</td><td align="right">'+obj.spot+'</td><td align="right">'+obj.spot9+'</td><td align="right">'+sel_spot+'</td><td align="right">'+aku_spot.replace(".", ",")+'</td>'); 
			
			$('#costed_summ').html('<td align="left">Total Cost</td><td align="right">'+obj.cost+'</td><td align="right">'+obj.cost9+'</td><td align="right">'+sel_cost+'</td><td align="right">'+aku_cost.replace(".", ",")+'</td>'); 
			
			$('#totvr_summ').html('<td align="left">Total TVR</td><td align="right">'+obj.tvr+'</td><td align="right">'+obj.tvr9+'</td><td align="right">'+sel_tottvr.replace(".", ",")+'</td><td align="right">'+aku_tottvr.replace(".", ",")+'</td>'); 
			
			$('#maxtvr_summ').html('<td align="left">Maximum TVR</td><td align="right">'+obj.maxtvr+'</td><td align="right">'+obj.maxtvr9+'</td><td align="right">'+sel_maxtvr.replace(".", ",")+'</td><td align="right">'+aku_maxtvr.replace(".", ",")+'</td>'); 
			
			$('#mintvr_summ').html('<td align="left">Minimum TVR</td><td align="right">'+obj.mintvr+'</td><td align="right">'+obj.mintvr9+'</td><td align="right">'+sel_mintvr.replace(".", ",")+'</td><td align="right">'+aku_mintvr.replace(".", ",")+'</td>'); 
			
			$('#avgtvr_summ').html('<td align="left">Average TVR</td><td align="right">'+obj.avgtvr+'</td><td align="right">'+obj.avgtvr9+'</td><td align="right">'+sel_avgtvr.replace(".", ",")+'</td><td align="right">'+aku_avgtvr.replace(".", ",")+'</td>'); 
			
			$('#cprp_summ').html('<td align="left">CPRP</td><td align="right">'+obj.cprp1+'</td><td align="right">'+obj.cprp19+'</td><td align="right">'+sel_cprp+'</td><td align="right">'+aku_cprp.replace(".", ",")+'</td>'); 
			
			$('#cpv_summ').html('<td align="left">Cost per Audience</td><td align="right">'+obj.cpv1+'</td><td align="right">'+obj.cpv19+'</td><td align="right">'+sel_apv+'</td><td align="right">'+aku_apv.replace(".", ",")+'</td>'); 
         ...
         var table1 = $("#example1").DataTable({   
			 dom: 'Bfrtip',
              ...
              "language": {
          		...
          		"serverSide": true,
          		destroy: true,
          		"ajax": "<?php echo base_url().'advancemediaplanningures/list_planning_sub'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&end_date=" + end_date + "&profile=" + profile + "&cost=" + cost + "&high_tvr=" + high_tvr + "&maximum_cost=" + maximum_cost+ "&discount=" + discount + "&minimum_cprp=" + minimum_cprp+"&maximum_reach=" + maximum_reach+"&index=" + index+"&channel=" + channel,
          		"searchDelay": 700,
          		"bFilter" : false,
          		"bInfo" : false,
          		"bLengthChange": false,  
          ...
          var token = $.cookie(window.cookie_prefix + "token");
         	var table2 = $("#example2").DataTable({
              ...
              "language": {
          		...
          		"serverSide": true,
          		destroy: true,
          		"ajax": "<?php echo base_url().'advancemediaplanningures/list_planning_total'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&end_date=" + end_date + "&profile=" + profile + "&cost=" + cost + "&high_tvr=" + high_tvr + "&maximum_cost=" + maximum_cost+ "&discount=" + discount + "&minimum_cprp=" + minimum_cprp+"&maximum_reach=" + maximum_reach+"&index=" + index+"&channel=" + channel,
          		"searchDelay": 700,
          		"bFilter" : false,
          		"bInfo" : false,
          		"iDisplayLength": 100,
	  ...
	  function refreshtablefilter(start_date,end_date,profile,cost,high_tvr,maximum_cost,minimum_cprp,maximum_reach,index,ch,orderingnya,by){
		   var user_id = $.cookie(window.cookie_prefix + "user_id");
          var token = $.cookie(window.cookie_prefix + "token");
      ...
      function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'advancemediaplanningures/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query,
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
    ...
    function search_profile(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'advancemediaplanningures/profilesearch/'; ?>"+"?q="+query+"&f="+period,
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
                $("#profile").next().next().next().empty('');
