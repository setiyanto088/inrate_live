	...
	if($('#fta_channel_programcc').is(':checked')){
	 ...
	 $("#table_program_channel").append(' <img alt="img" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif">');
 		...
 		var tahun = $('#periode_head').val();
			...
			$.ajax({
				url: "<?php echo base_url().'dashboardareauseetv/filter_program_detail'; ?>", 
				...
				success: function(data){
					...
					var table_html = '<table aria-describedby="mydesc"  id="example3s" class="table table-striped " style=" font-size:14px !important;table-layout:fixed;"><thead style="color:red"><tr><th rowspan="2" style="width:15px">Rank </th><th colspan="2">Program </th></tr><tr><th>Program</th><th>Channel</th></tr></thead></table>';
	...
	if($('#fta_channel').is(':checked')){
	 ...
	 $("#table_program_channel").append(' <img alt="img" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif">');
 		...
 		var tahun = $('#periode_head').val();
			...
			$.ajax({
				url: "<?php echo base_url().'dashboardareauseetv/filter_channel_detail'; ?>", 
				dataType: 'json',  // what to expect back from the PHP script, if anything
				cache: false,
				contentType: false,
				processData: false,
				...
				success: function(data){
					...
					var table_html = '<table aria-describedby="mydesc"  id="example3s" class="table table-striped " style=" font-size:14px !important;table-layout:fixed"><thead style="color:red"><tr><th style="width:15px">Rank </th><th >Channel </th></tr></thead></table>';
