              ...
              <div class="panel-body">
				...
				<div class="result-table" style="overflow-x:hidden">
								...
								<div id="table_program_channel">
									<table aria-describedby="mydesc"  id="example3" class="table table-striped" style="overflow-x:auto;white-space: nowrap; font-size:12px !important;width:100%">
										<thead style="color:red">
											<tr>
												<th style="width:15px" scope="row">Rank </th>
												<th  scope="row">Area 01 </th>
												<th  scope="row">Area 02 </th>
												<th  scope="row">Area 03 </th>
												<th  scope="row">Area 04 </th>
											</tr>
              ...
              <div class="panel-body">
				...
				<div class="result-table" style="overflow-x:hidden">
								...
								<div id="table_program">
									<table aria-describedby="mydesc"  id="example32" class="table table-striped" style=" overflow-x:auto;white-space: nowrap; font-size:12px !important;width:100%">
										<thead  style="color:red">
											<tr>
												<th style="width:15px" scope="row">Rank </th>
												<th  scope="row">Area 01 </th>
              ...
              <div class="panel-body">
				...
				<div class="result-table" style="overflow-x:hidden">
								...
								<div id="table_program_program">
									<table aria-describedby="mydesc"  id="example34" class="table table-striped" style=" overflow-x:auto;white-space: nowrap; font-size:12px !important;width:100%">
										<thead  style="color:red">
											<tr>
												<th style="width:15px" scope="row">Rank </th>
												<th  scope="row">Area 01 </th>
	 ...
	 $("#table_program_channel").append(' <img alt="img" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif">');
		...
		var tahun = $('#periode_head').val();
			...
			$.ajax({
				...
				url: "<?php echo base_url().'dashboardareauseetv/filter_channel'; ?>", 
			...
			$.ajax({
				url: "<?php echo base_url().'dashboardareauseetv/filter_program'; ?>", 
				dataType: 'json',  // what to expect back from the PHP script, if anything
				cache: false,
				contentType: false,
				processData: false,
...
function table_sel(){
		...
		var tahun = $('#periode_head').val();
			...
			$.ajax({
				...
				success: function(data){
					...
					var table_html = '<table aria-describedby="mydesc"  id="example3" class="table table-striped" style="overflow-x:auto;white-space: nowrap; font-size:12px !important;width:100%"><thead style="color:red"><tr><th style="width:15px" scope="row">Rank </th><th  scope="row">Area 01 </th><th  scope="row">Area 02 </th><th  scope="row">Area 03 </th><th  scope="row">Area 04 </th></tr></thead></table>';
	...
	$('#table_program').html("");
	$('#table_program').append('<table aria-describedby="mydesc"  id="example32" class="table table-striped" style=" overflow-x:auto;white-space: nowrap; font-size:12px !important;width:100%"><thead  style="color:red"><tr><th style="width:15px" scope="row">Rank </th><th  scope="row">Area 01 </th><th  scope="row">Area 02 </th><th  scope="row">Area 03 </th><th  scope="row">Area 04 </th></tr></thead></table>');
		...
		var tahun = $('#periode_head').val();
			...
			$.ajax({
				...
				success: function(data){
					...
					var table_html = '<table aria-describedby="mydesc"  id="example34" class="table table-striped" style=" overflow-x:auto;white-space: nowrap; font-size:12px !important;width:100%"><thead  style="color:red"><tr><th style="width:15px" scope="row">Rank </th><th  scope="row">Area 01 </th><th  scope="row">Area 02 </th><th  scope="row">Area 03 </th><th  scope="row">Area 04 </th></tr></thead></table>';
