        ...
        <!-- / Dashboard Stats -->
			   ...
			   <div class="col-lg-12" style="" >	
						<div class="col-lg-10" style="margin-top:-20px">	
										<h3><strong>Area <?php echo "0".str_replace('0','',$regional_text); ?></strong></h3>
						</div> 
						<div class="col-lg-2" >						
	 ...
	 $("#table_program_channel").append(' <img alt="img" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif">');
 		...
 		var tahun = $('#periode_head').val();
			...
			$.ajax({
				...
				url: "<?php echo base_url().'dashboardareauseetv/filter_channel_reg'; ?>", 
			...
			$.ajax({
				url: "<?php echo base_url().'dashboardareauseetv/filter_program_reg'; ?>", 
				dataType: 'json',  // what to expect back from the PHP script, if anything
				cache: false,
				contentType: false,
				processData: false,
